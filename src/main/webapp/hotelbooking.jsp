...
<body>
<form action="HotelReservationDB" method="post">
    <label for="dIn" class="mt-2">DateIn</label>
    <input id="dIn" type="date" name="dIn" class="form-control ">
    <label for="dOut" class="mt-2">DateOut</label>
    <input id="dOut" type="date" name="dOut" class="form-control ">
    <label for="status" class="mt-2">Status</label>
    <input id="status" type="text" name="status" placeholder="EnterStatus" class="form-control ">
    <label for="cID" class="mt-2">ClienID</label>
    <input id="cID" type="text" name="cID" placeholder="EnterClientName" class="form-control ">
